...
Промежуточные операции всегда возвращают новый Stream, поэтому их можно 
выстраивать в цепочки. Они не запускают выполнение, а только добавляют шаг в конвейер.
