...
Промежуточные операции не запускают обработку элементов, а только добавляют шаг в конвейер.
...
peek — промежуточная операция для логирования,
forEach — терминальная, запускает выполнение стрима.
