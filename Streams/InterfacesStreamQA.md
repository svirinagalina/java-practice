...
Функциональное программирование описывает вычисления через чистые функции без изменения состояния и побочных эффектов. Подходит для обработки данных, параллелизма и декларативных преобразований коллекций, в отличие от ООП/процедурного стиля, где фокус на изменяемых объектах и пошаговых командах.
